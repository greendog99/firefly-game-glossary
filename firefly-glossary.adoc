...
for *Outlaw Ships*. It moves in 3 different ways:
...
[.expansion]#Pirates#
Any time the "`Alliance Cruiser`" Nav Card is drawn, return the 3 face-up
...
action from any location to *Consider* 3 Capers and keep up to 2. If you draw
...
When *Buying* cards or *Dealing* with Contacts, you may Consider 3 cards, and
may take up to 2 of those cards:

* Look through the discard pile for the Supply Planet or Contact and choose up to
3 cards to consider.
* For each card less than 3 that you consider from the discard pile, you may draw 1
...
You may not have more than 3 inactive Jobs or Challenges in your hand at any time.

=== Deceptive

Only one Deceptive crew member may be in play at any time. When a Deceptive
Crew is hired by any player, any other Deceptive crew already in play is
removed from the game.

[.expansion]#Flying# When playing with the *Capers* Deck, when a Deceptive Crew
is hired by any player, any other Deceptive crew already in play is shuffled
back into its supply deck.
...
fuel exchange system (6 stash spaces for fuel only).
...
Upgrades, and can only carry 4 Crew on the Job.
