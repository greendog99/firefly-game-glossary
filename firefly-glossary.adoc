...
[.expansion]#SF# If you have a Deceptive Crew member, you can use a Deal action
from any location to *Consider* 3 Capers and keep up to 2. If you draw the
"Reshuffle" card while considering Capers, resolve it immediately.
...
Only one Deceptive crew member may be in play at any time. Any time a Deceptive
Crew is hired, any Deceptive crew already in play is removed from the game.

[.expansion]#SF# When playing with the *Capers* Deck, any time a Deceptive Crew
is hired, any Deceptive crew already in play is shuffled back into its supply
deck.
...
[.expansion]#SF# Whenever your Crew jumps ship (after being disgruntled twice,
